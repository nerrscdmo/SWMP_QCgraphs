...
5/4/26 - the above link no longer exists, but it seems that time zones span ~15 degrees each. Based on this site: https://www.gi.alaska.edu/alaska-science-forum/time-zones , additional longitudes for time zones are 135 Yukon (GMT-9); 150 Alaska (-10); 165 Bering (-11); 180 for ?? (-12 / +12).  

Eastern is GMT-5; Central -6; Mountain -7; Pacific -8. Can use time zones ('GMT Offset') and longitudes from `sampling_stations.csv` that comes with every CDMO download to make a table for this.  
